          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              ...
              <button
                ...
                className="bg-[#FF6B35] text-white px-6 py-3 rounded-xl font-semibold hover:bg-[#E55A2B] active:scale-95 transition-all shadow-lg shadow-[#FF6B35]/20 flex items-center gap-2 whitespace-nowrap w-full lg:w-auto justify-center"
              >
