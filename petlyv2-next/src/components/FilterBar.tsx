...
const FilterCards = ({
  ...
  return (
    <section className="py-10 border-b border-white/10 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="flex items-center gap-2 mb-6">
          <div className="w-1 h-5 bg-[#A23B72] rounded-full shadow-[0_0_8px_rgba(162,59,114,0.8)]"></div>
          <p className="text-sm font-semibold text-gray-400 uppercase tracking-wider">Filtrar por tipo de pet</p>
        </div>
              ...
              <button
                ...
                className={`flex flex-col items-center justify-center p-4 rounded-xl border-2 transition-all ${
                  isActive
                    ...
                    : 'bg-white/5 text-gray-300 border-white/10 hover:border-[#FF6B35]/50 hover:bg-white/10 backdrop-blur-sm'
                }`}
              >
