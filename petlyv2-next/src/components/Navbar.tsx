      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            ...
            <span className="text-lg font-bold text-gray-900 hidden sm:inline">Petly</span>
          </Link>
        ...
        <div className="md:hidden border-t border-gray-200 bg-white px-4 pb-4 flex flex-col gap-2">
          <Link
            ...
            className={`py-2 text-sm font-medium transition-colors ${
              pathname === '/cuidadores' ? 'text-[#FF6B35]' : 'text-gray-600'
            }`}
          >
            Encontrar Cuidador
          </Link>
          <button
            ...
            className="py-2 text-sm font-medium text-gray-600 transition-colors text-left"
          >
            Ser um Cuidador
          </button>
          <button
